<?php
 ...
 include('../../src/MyFPDF.php');
	...
	//recupero variabkes
	$sbRadicado			= $_REQUEST["txtRadicado"];
 ...
 //Conexión con la base de datos
  ...
  $pdf->Cell(0,4,'',0,1,'C');
   ...
   $pdf->Cell(0,10,"",0,1,'',0);
    ...
    $pdf->Cell(22,5,'REMITENTES',1,0,'C');
    $pdf->Cell(75,5,'ENTIDAD / DEPENDENCIA',1,0,'C');
	$pdf->Cell(75,5,'DESTINATARIO',1,0,'C');	
	$pdf->Cell(14,5,'FOLIOS',1,0,'C');	 	 
	$pdf->Cell(36,5,'FIRMA',1,1,'C');	 
    $pdf->SetFont('Arial','',8);
   ...
   while($row=mysqli_fetch_array($result,MYSQLI_NUM))
	...
	$pdf->Cell(18,5,$sbFecha,1,0,'C');	 
	$pdf->Cell(16,5,$sbHora,1,0,'C');
    $pdf->Cell(22,5,$sbRemitente,1,0,'C');
    $pdf->Cell(75,5,$sbEntidad_dependencia,1,0,'C');
	$pdf->Cell(75,5,$sbDestinatorio,1,0,'C');	
