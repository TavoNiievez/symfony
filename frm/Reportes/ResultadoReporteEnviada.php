...
<?php
   ...
   <form name="frmReporte" action="../../reportes/CEnviada/RangoFechas.php" method ="post"  onSubmit=  "validarIngreso(this)"  enctype="multipart/form-data">
		<center>
		<table>
   ...
   <form name="frmReporte" action="../../reportes/CEnviada/Remitente.php" method ="post"  onSubmit=  "validarIngreso(this)"  enctype="multipart/form-data">
		<center>
		<table>
   ...
   <form name="frmReporte" action="../../reportes/CEnviada/Destinatario.php" method ="post"  onSubmit=  "validarIngreso(this)"  enctype="multipart/form-data">
		<center>
		<table>
   ...
   <form name="frmReporte" action="../../reportes/CEnviada/RadicadoIncial.php" method ="post"  onSubmit=  "validarIngreso(this)"  enctype="multipart/form-data">
		<center>
		<table>
   ...
   <form name="frmReporte" action="../../reportes/CEnviada/ReporteDiario.php" method ="post"  onSubmit=  "validarIngreso(this)"  enctype="multipart/form-data">
		<center>
		<table>
