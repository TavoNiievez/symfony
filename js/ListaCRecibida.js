...
function BuscarLista(url,form){
	...
	form.txtAgrupacionInfoSQL.value = form.txtRadicado.value +'-'+ form.txtRemitentes.value +'-'+ form.txtEntidad_Dependencia.value +'-'+
					form.txtDestinatario.value+'-'+ form.txtFolios.value +'-'+	form.txtFecha.value +'-'+form.txtHora.value+'-'+form.cmbVigencia.value;
