...
function BuscarLista(url,form){
	...
	form.txtAgrupacionInfoSQL.value = form.txtRadicado.value +'-'+ form.txtRadicadoInicial.value +'-'+ 
					 form.txtRemitente.value +'-'+ form.txtDestinatario.value+'-'+ form.txtEntidad.value+'-'+
					 form.txtFolios.value +'-'+ form.txtFecha.value+'-'+form.txtHora.value+'-'+form.cmbVigencia.value;
