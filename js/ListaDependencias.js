...
function BuscarLista(url,form){
	...
	form.txtAgrupacionInfoSQL.value = form.txtCodigo.value +'-'+ form.txtDepedencia.value +'-'+ form.txtNombre.value +'-'+
					form.txtApellido.value;
	
	divResultado = document.getElementById('ListadoMaestro');
	...
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4) {
			...
			document.getElementById('ListadoMaestro').innerHTML = ajax.responseText;
		}
	}
